...
const trainingGuideMarkup = `
  <main class="training-guide">
    ...
    <section class="training-guide-section">
      ...
      <p>После завершения чемпион автоматически запускается на Canvas. Скорость validation replay можно менять от 1x до 1000x. Кнопка «CSV отчёт» скачивает статистику поколений.</p>
    </section>
